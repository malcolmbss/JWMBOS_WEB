...
!(function (c) {
    ...
    function m(s, e, l) {
        function t(i, a) {
            ...
            function e(e, t) {
                t && c.console && console.log(t), e && g("Blob", e) ? (n = f((s = e))) : ((n = s), l && l.crossOrigin && (r.crossOrigin = l.crossOrigin)), (r.src = n);
            }
            return (
                ...
                (r.onload = function () {
                    u(n, l);
                    var e = { originalWidth: r.naturalWidth || r.width, originalHeight: r.naturalHeight || r.height };
                    try {
                ...
                "string" == typeof s
                    ? (m.requiresMetaData(l) ? m.fetchBlob(s, e, l) : e(), r)
                    : g("Blob", s) || g("File", s)
                    ? (n = f(s))
                        ? ((r.src = n), r)
                        : d(
    ...
    (function (e) {
        ...
        (E.createCanvas = function (e, t, i) {
            ...
            (E.getTransformedOptions = function (e, t) {
                ...
                return (i.crop = !0), o < (n = e.naturalWidth || e.width) / (r = e.naturalHeight || e.height) ? ((i.maxWidth = r * o), (i.maxHeight = r)) : ((i.maxWidth = n), (i.maxHeight = n / o)), i;
            }),
            (E.drawImage = function (e, t, i, a, n, r, o, s, l) {
                var c = t.getContext("2d");
                return (
                    !1 === l.imageSmoothingEnabled ? ((c.msImageSmoothingEnabled = !1), (c.imageSmoothingEnabled = !1)) : l.imageSmoothingQuality && (c.imageSmoothingQuality = l.imageSmoothingQuality),
                    c.drawImage(e, i, a, n, r, 0, 0, o, s),
                    c
                );
            }),
            ...
            (E.scale = function (e, t, i) {
                ...
                var a,
                    ...
                    g,
                    m,
                    h = e.getContext || (E.requiresCanvas(t) && !!E.global.HTMLCanvasElement),
                    p = e.naturalWidth || e.width,
                ...
                if (
                    (h &&
                        ((c = (t = E.getTransformedOptions(e, t, i)).left || 0),
                        (f = t.top || 0),
                    ...
                    h && a && n && t.crop
                        ? (g = s / l - (b = a) / (y = n)) < 0
                            ? ((l = (n * s) / a), t.top === undefined && t.bottom === undefined && (f = (A - l) / 2))
                            : 0 < g && ((s = (a * l) / n), t.left === undefined && t.right === undefined && (c = (p - s) / 2))
                        : ((t.contain || t.cover) && ((r = a = a || r), (o = n = n || o)), t.cover ? (v(), S()) : (S(), v())),
                    h)
                ) {
                    if (
                        (1 < (u = t.pixelRatio) && (!e.style.width || Math.floor(parseFloat(e.style.width, 10)) !== Math.floor(p / u)) && ((b *= u), (y *= u)),
                        E.orientationCropBug && !e.getContext && (c || f || s !== p || l !== A) && ((g = e), (e = E.createCanvas(p, A, !0)), E.drawImage(g, e, 0, 0, p, A, p, A, t)),
                        0 < (d = t.downsamplingRatio) && d < 1 && b < s && y < l)
                    )
                        for (; b < s * d; ) (m = E.createCanvas(s * d, l * d, !0)), E.drawImage(e, m, c, f, s, l, m.width, m.height, t), (f = c = 0), (s = m.width), (l = m.height), (e = m);
                    return (m = E.createCanvas(b, y)), E.transformCoordinates(m, t, i), 1 < u && (m.style.width = m.width / u + "px"), E.drawImage(e, m, c, f, s, l, b, y, t).setTransform(1, 0, 0, 1, 0, 0), m;
                }
    ...
    (function (e) {
        ...
        var s = o.global,
            l = o.transform,
            a = s.Blob && (Blob.prototype.slice || Blob.prototype.webkitSlice || Blob.prototype.mozSlice),
            m =
                (s.ArrayBuffer && ArrayBuffer.prototype.slice) ||
                function (e, t) {
                    t = t || this.byteLength - e;
                    var i = new Uint8Array(this, e, t),
                        a = new Uint8Array(t);
        ...
        function c(t, e, u, d) {
            ...
            return (u = u || {}), s.Promise && "function" != typeof e ? ((d = u = e || {}), new Promise(i)) : ((d = d || {}), i(e, e));
        }
        function n(e, t, i) {
            return e && t && i ? new Blob([i, a.call(e, t.byteLength)], { type: "image/jpeg" }) : null;
        }
        (o.transform = function (t, i, a, n, r) {
            o.requiresMetaData(i)
                ? c(
                      n,
                      function (e) {
            ...
            (o.blobSlice = a),
            (o.bufferSlice = m),
            (o.replaceHead = function (t, i, a) {
                var e = { maxMetaDataSize: 256, disableMetaDataParsers: !0 };
                if (!a && s.Promise)
    ...
    (function (e) {
        ...
        "use strict";
        var r = e.global;
        r.fetch && r.Request && r.Response && r.Response.prototype.blob
            ? (e.fetchBlob = function (e, t, i) {
                  function a(e) {
                      return e.blob();
                  }
              ...
              (e.fetchBlob = function (e, t, n) {
                  function i(t, i) {
                      ...
                      a.open(n.method || "GET", e),
                          ...
                          (a.withCredentials = "include" === n.credentials),
                          (a.responseType = "blob"),
                          (a.onload = function () {
                              t(a.response);
                          }),
    ...
    (function (e) {
        ...
        "function" == typeof define && define.amd
            ...
            : "object" == typeof module && module.exports
            ? e(require("./load-image"), require("./load-image-scale"), require("./load-image-meta"))
            : e(window.loadImage);
    })(function (h) {
        "use strict";
        var t,
            ...
            n = h.transform,
            a = h.requiresCanvas,
            r = h.requiresMetaData,
            f = h.transformCoordinates,
            p = h.getTransformedOptions;
        function o(e, t) {
        ...
        (t = h).global.document &&
            (((i = document.createElement("img")).onload = function () {
                var e;
                (t.orientation = 2 === i.width && 3 === i.height),
                    t.orientation && ((e = t.createCanvas(1, 1, !0).getContext("2d")).drawImage(i, 1, 1, 1, 1, 0, 0, 1, 1), (t.orientationCropBug = "255,255,255,255" !== e.getImageData(0, 0, 1, 1).data.toString()));
            }),
            (i.src =
            ...
            (h.transform = function (e, t, r, i, a) {
                n.call(
                    ...
                    function (e, t) {
                        var i, a, n;
                        !t || (4 < (i = h.orientation && t.exif && t.exif.get("Orientation")) && i < 9 && ((a = t.originalWidth), (n = t.originalHeight), (t.originalWidth = n), (t.originalHeight = a))), r(e, t);
                    },
                    i,
                    a
                );
            ...
            (h.getTransformedOptions = function (e, t, i) {
                var a = p.call(h, e, t),
                    n = i.exif && i.exif.get("Orientation"),
                    r = a.orientation,
                    o = h.orientation && n;
                ...
                if (
                    (((4 < (g.orientation = r) && !(4 < o)) || (r < 5 && 4 < o)) &&
                        ((g.maxWidth = a.maxHeight), (g.maxHeight = a.maxWidth), (g.minWidth = a.minHeight), (g.minHeight = a.minWidth), (g.sourceWidth = a.sourceHeight), (g.sourceHeight = a.sourceWidth)),
                    1 < o)
                ) {
                    switch (o) {
                        case 2:
            ...
            (h.transformCoordinates = function (e, t, i) {
                f.call(h, e, t, i);
                var a = t.orientation,
                    n = h.orientation && i.exif && i.exif.get("Orientation");
                if (A(a, n)) {
                    var r = e.getContext("2d"),
                        ...
                        l = o,
                        c = s;
                    switch ((((4 < a && !(4 < n)) || (a < 5 && 4 < n)) && ((e.width = s), (e.height = o)), 4 < a && ((l = s), (c = o)), n)) {
                        case 2:
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            r.rotate(-0.5 * Math.PI), r.translate(-l, 0);
                            break;
                        case 7:
                            r.rotate(-0.5 * Math.PI), r.translate(-l, c), r.scale(1, -1);
                            break;
                        case 8:
                            r.rotate(0.5 * Math.PI), r.translate(0, -c);
                    }
                    switch ((b(a, n) && (r.translate(l, c), r.rotate(Math.PI)), a)) {
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            r.rotate(0.5 * Math.PI), r.translate(0, -s);
                            break;
                        case 7:
                            r.rotate(0.5 * Math.PI), r.translate(o, -s), r.scale(-1, 1);
                            break;
                        case 8:
                            r.rotate(-0.5 * Math.PI), r.translate(-o, 0);
                    }
                }
            });
    }),
    (function (e) {
        ...
        "use strict";
        function h(e) {
            e && (Object.defineProperty(this, "map", { value: this.ifds[e].map }), Object.defineProperty(this, "tags", { value: (this.tags && this.tags[e]) || {} }));
        }
        (h.prototype.ifds = {
            ifd1: { name: "Thumbnail", map: (h.prototype.map = { Orientation: 274, Thumbnail: "ifd1", Blob: 513, Exif: 34665, GPSInfo: 34853, Interoperability: 40965 }) },
            34665: { name: "Exif", map: {} },
        ...
        function A(e, t, i, a, n, r, o, s) {
            ...
            if (i + 6 > e.byteLength) console.log("Invalid Exif data: Invalid directory offset.");
                ...
                if (!((c = i + 2 + 12 * (l = e.getUint16(i, a))) + 4 > e.byteLength)) {
                    for (f = 0; f < l; f += 1)
                        (u = i + 2 + 12 * f),
                            p(o, s, (d = e.getUint16(u, a))) &&
                                ((g = (function (e, t, i, a, n, r) {
                                    var o,
                                        s,
                                        l,
                                        c,
                                ...
                                })(e, t, u, e.getUint16(u + 2, a), e.getUint32(u + 4, a), a)),
                                (n[d] = g),
                                r && (r[d] = u));
        ...
        (m[7] = m[1]),
            (r.parseExifData = function (c, e, t, f, i) {
                if (!i.disableExif) {
                    var u,
                        a,
                        n,
                        d = i.includeExifTags,
                        g = i.excludeExifTags || { 34665: { 37500: !0 } },
                        m = e + 10;
                    if (1165519206 === c.getUint32(e + 4))
                        if (m + 8 > c.byteLength) console.log("Invalid Exif data: Invalid segment size.");
                        else if (0 === c.getUint16(e + 8)) {
                            ...
                            42 === c.getUint16(m + 2, u)
                                ? ((a = c.getUint32(m + 4, u)),
                                  (f.exif = new h()),
                                  i.disableExifOffsets || ((f.exifOffsets = new h()), (f.exifTiffOffset = m), (f.exifLittleEndian = u)),
                                  (a = A(c, m, m + a, u, f.exif, f.exifOffsets, d, g)) && p(d, g, "ifd1") && ((f.exif.ifd1 = a), f.exifOffsets && (f.exifOffsets.ifd1 = m + a)),
                                  Object.keys(f.exif.ifds).forEach(function (e) {
                                      var t, i, a, n, r, o, s, l;
                                      (i = e),
                                          (a = c),
                                          (n = m),
                                          ...
                                          (o = d),
                                          (s = g),
                                          (l = (t = f).exif[i]) && ((t.exif[i] = new h(i)), t.exifOffsets && (t.exifOffsets[i] = new h(i)), A(a, n, n + l, r, t.exif[i], t.exifOffsets && t.exifOffsets[i], o && o[i], s && s[i]));
                                  }),
                                  (n = f.exif.ifd1) &&
                                      n[513] &&
                                      (n[513] = (function (e, t, i) {
                                          if (i) {
                                              if (!(t + i > e.byteLength)) return new Blob([r.bufferSlice.call(e.buffer, t, t + i)], { type: "image/jpeg" });
            ...
            r.metaDataParsers.jpeg[65505].push(r.parseExifData),
            (r.exifWriters = {
                274: function (e, t, i) {
            ...
            (r.writeExifData = function (e, t, i, a) {
                r.exifWriters[t.exif.map[i]](e, t, a);
            }),
            (r.ExifMap = h);
    }),
    (function (e) {
        ...
        (n.tags = {
            ...
            (n.stringValues = {
                ...
                Orientation: { 1: "Original", 2: "Horizontal flip", 3: "Rotate 180° CCW", 4: "Vertical flip", 5: "Vertical flip + Rotate 90° CW", 6: "Rotate 90° CW", 7: "Horizontal flip + Rotate 90° CW", 8: "Rotate 90° CCW" },
            }),
            ...
            (function () {
                ...
                for (e in a)
                    if (Object.prototype.hasOwnProperty.call(a, e))
                        if ((t = n.ifds[e])) for (e in (i = a[e])) Object.prototype.hasOwnProperty.call(i, e) && (t.map[i[e]] = Number(e));
                        else n.map[a[e]] = Number(e);
            })();
    }),
    (function (e) {
        "use strict";
        ...
        function h(e, t, i, a, n, r) {
            for (var o, s, l, c, f, u = t + i, d = t; d < u; )
                28 === e.getUint8(d) &&
                    2 === e.getUint8(d + 1) &&
                    ((l = e.getUint8(d + 2)),
                    (n && !n[l]) ||
                        (r && r[l]) ||
                        ((s = e.getInt16(d + 3)), (o = m(l, a.iptc, e, d + 5, s)), (a.iptc[l] = ((c = a.iptc[l]), (f = o), c === undefined ? f : c instanceof Array ? (c.push(f), c) : [c, f])), a.iptcOffsets && (a.iptcOffsets[l] = d))),
                    (d += 1);
        }
        (g.prototype.map = { ObjectName: 5 }),
            (g.prototype.types = { 0: "Uint16", 200: "Uint16", 201: "Uint16", 202: "binary" }),
            (g.prototype.get = function (e) {
                return this[e] || this[this.map[e]];
            }),
            (e.parseIptcData = function (e, t, i, a, n) {
                if (!n.disableIptc)
                    for (var r, o, s, l, c = t + i; t + 8 < c; ) {
                        if (((l = t), 943868237 === (s = e).getUint32(l) && 1028 === s.getUint16(l + 4))) {
                            var f = ((r = t), (o = void 0), (o = e.getUint8(r + 7)) % 2 != 0 && (o += 1), 0 === o && (o = 4), o),
                                u = t + 8 + f;
                            if (c < u) {
                            ...
                            return (a.iptc = new g()), n.disableIptcOffsets || (a.iptcOffsets = new g()), void h(e, u, d, a, n.includeIptcTags, n.excludeIptcTags || { 202: !0 });
                        }
                        t += 1;
                    }
            }),
    ...
    (function (e) {
        ...
        (a.tags = {
            ...
            (a.stringValues = {
                10: { 0: "0 (reserved)", 1: "1 (most urgent)", 2: "2", 3: "3", 4: "4", 5: "5 (normal urgency)", 6: "6", 7: "7", 8: "8 (least urgent)", 9: "9 (user-defined priority)" },
