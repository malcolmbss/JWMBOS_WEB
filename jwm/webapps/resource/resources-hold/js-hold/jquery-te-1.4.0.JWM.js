...
(function($){
        $.fn.jqte = function(options){
                ...
                // methods
// JWM updated from stackoverflow to add a setter (only had a getter)
                $.fn.jqteVal = function(value)
                {
                    var editor = $(this).closest("."+vars.css).find("."+vars.css+"_editor");
...
//                      console.log('<div class="'+vars.css+"_toolbar"+'" role="toolbar" unselectable></div><div class="'+vars.css+'_linkform" style="display:none" role="dialog"></div><div id="'+vars.uid+ '" class="'+vars.css+"_editor"+'"></div>');
                        jQTE.html('<div class="'+vars.css+"_toolbar"+'" role="toolbar" unselectable></div><div class="'+vars.css+'_linkform" style="display:none" role="dialog"></div><div id="'+vars.uid+ '" class="'+vars.css+"_editor"+'"></div>');
                        ...
                        {
//jwm - 05/13/17 -- completely remove this fn... just keep html untouched... sections being inadvertently erased....
                            return( strings );
...
//                              return $htmlContent;
                        ...
                        function postToSource()
                        {
                                ...
                                var textAreaElement = document.getElementById( thisElement.attr("id") );
                        }
...
//                              var textAreaElement = document.getElementById( thisElement.attr("id") );
                        ...
                        {
                           var currContent = editor.html();
//                         console.log( "save Content -- " + vars.uid + " = " + currContent);
                           if (typeof(Storage) !== "undefined")
                           {
                               localStorage.setItem(vars.uid, currContent);
                           }
                        }
...
//                                              vars.change();
                                ...
                                // JWM addition 5/12/17
                                .bind("postToSource",function()
                                {
                                   postToSource();
